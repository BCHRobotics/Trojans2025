...
public class AlignRightCommand extends Command{
   ...
   public AlignRightCommand(Double rotationSpeed,BooleanSupplier fieldRelative, BooleanSupplier rateLimit, Drivetrain subsystem){
        commandRot = rotationSpeed;
        rotationSpeed = pid.calculate(PhotonVision.rightYaw,0);
